 ...
 * @author Mai
 */
@WebServlet(name = "PlayAlbum", urlPatterns = {"/PlayAlbum"})
public class PlayAlbum extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PlayAlbum</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PlayAlbum at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//            response.getWriter().print(request.getContextPath());
            request.getRequestDispatcher("Views/PlaySong.jsp").forward(request, response);
        } catch (Exception e) {
