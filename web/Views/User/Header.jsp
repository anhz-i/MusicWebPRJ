    ...
    <body class="">
        <header>
            <div id="subMenu">
                ...
                <!--                <div class = "infor">
                                    <img src="${pageContext.request.contextPath}\Images\Banner.jpg" alt="NotUpdated"/>
                                </div>-->
                ...
                <div class="sign">
                    <div>
                        <div>
                            ...
                            <div class="sign-in-up">
                                <a href="${pageContext.request.contextPath}/ChangePass" title="Change password">
                                    Change password
                                </a>
                            </div>

                            <div class="sign-in-up">
                                <a href="${pageContext.request.contextPath}/MyProfile" title="My Profile">
                                    My Profile
                                </a>
                    ...
                    <div style="clear:both;float:left" class="search-container">
                        <form action="#">
